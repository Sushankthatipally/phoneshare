/*
 * DropBeam guest browser page.
 *
 * Renders the HTML/CSS/JS served at `/guest/:token` to a stranger on the same LAN.
 ...
 * (`packages/shared-ui/src/tokens.css`) so the guest page matches the rest of
...
/**
 * Render the guest browser HTML for a share record.
 *
...
<head>
  <meta charset="utf-8" />
  <title>DropBeam &mdash; Shared with you</title>
  ...
  <main class="db-shell">
    <header class="db-header">
      ...
      <div class="db-header__text">
        <p class="db-header__eyebrow">DropBeam &middot; Guest share</p>
